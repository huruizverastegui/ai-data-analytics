...
with st.expander("Create a new Data Analytics Knowledge Base", expanded=False):
...
with left:
   container_name = st.selectbox("Manage this Data Analytics Knowledge Base", list_all_containers())
...
uploaded_files = st.file_uploader(f"Add files to {container_name}", type=["xlsx", "csv"], accept_multiple_files=True)
