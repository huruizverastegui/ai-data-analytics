...
def list_all_containers():
    ...
    for container in containers:
        if "data-analytics" in container.name:
...
def create_new_container(container_name):
    genai_container = f"data-analytics-{container_name}"
...
def download_blob_to_file(blob_service_client: BlobServiceClient, container_name, blob_name):
    ...
    with open(file=os.path.join(r'./data-files/', blob_name), mode="wb") as sample_blob:
